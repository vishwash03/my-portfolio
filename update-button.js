...
content = content.replace(scriptEndPattern, jsAddition + '\n    </script>');
...
console.log('✓ Floating scroll-to-top button with arrow animation added successfully!');
